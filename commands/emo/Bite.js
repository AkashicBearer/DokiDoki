	...
	async run(message, args) {
        ...
        const embed = new MessageEmbed()
         if(message.author.id == args.member.id){
            embed.setDescription(message.author.username + ' bites.. themselves.. seems like someone needs some love. ')
            }else{
            embed.setDescription(message.author.username + ' bites ' + args.member.user.username)
            }
