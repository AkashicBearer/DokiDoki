	...
	async run(message, args) {
        ...
        const embed = new MessageEmbed()
         if(message.author.id == args.member.id){
            embed.setDescription(message.author.username + ' punches.. themselves.. are you alright? ')
            }else{
            embed.setDescription(message.author.username + ' punches ' + args.member.user.username)
            }
