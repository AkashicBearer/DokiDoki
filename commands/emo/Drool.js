        ...
        var imgdrool = {
           ...
           const embed = new MessageEmbed()
             if(message.author.id == args.member.id || !args.member){
                embed.setDescription(message.author.username + ' is drooling!')
             }else{
                embed.setDescription(message.author.username + ' thinks ' + args.member.user.username + ' looks appetizing!')  
             }
