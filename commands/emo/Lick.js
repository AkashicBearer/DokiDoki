	...
	async run(message, args) {
        ...
        const embed = new MessageEmbed()
         if(message.author.id == args.member.id){
            embed.setDescription(message.author.username + ' licks.. themselves.. do you taste that good? ')
            }else{
            embed.setDescription(message.author.username + ' licks ' + args.member.user.username)
            }
